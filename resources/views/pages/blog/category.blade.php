...
@section('meta_content') Blog poświęcony programowaniu i ciekawostkom ze świata IT - Śmigiela Daniel IT Solutions Opole | Kategoria: {{$category->name}} @endsection
@section('title') | Blog | {{$category->name}} @endsection
  ...
  @include('_inc.frontend.nav-otherpages')
    <div class="hero is-primary m-t-2">
     <div class="hero-body container">
       ...
       <h3 class="subtitle"><span style="font-style: italic">Widok postów z kategorii: </span>{{$category->name}}</h3>
     </div>
